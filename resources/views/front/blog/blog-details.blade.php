...
@section('front-body')
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <!-- Preview Image -->
                <img class="img-fluid rounded" src="{{ asset($blog->blog_image) }}" alt="{{ $blog->blog_title }}">
                <hr>
                <!-- Date/Time -->
                ...
                <div class="card my-4">
                    <div class="card-body">
                        <div class="card-title">
                            <h3 class="text-warning">You have to <a href="{{ route('visitor-login') }}">Login</a> or <a href="{{ route('visitor-sign-up') }}">Sign Up</a> for comment this blog. </h3>
                        </div>
                    </div>
                </div>
                @endif
                ...
                <div class="media mb-4">
                    ...
                    <div class="media-body">
                        <h5 class="mt-0">{{ $comment->visitor_name }}</h5>
                        <p>{{ $comment->comment }}</p>
                    </div>
                </div>
                @endforeach
