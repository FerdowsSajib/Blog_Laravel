...
-- Dumping structure for table db_blog.blogs
...
-- Dumping structure for table db_blog.categories
...
-- Data exporting was unselected.
-- Dumping structure for table db_blog.comments
...
-- Data exporting was unselected.
-- Dumping structure for table db_blog.migrations
...
-- Data exporting was unselected.
-- Dumping structure for table db_blog.password_resets
...
-- Data exporting was unselected.
-- Dumping structure for table db_blog.users
...
-- Data exporting was unselected.
-- Dumping structure for table db_blog.visitors
CREATE TABLE IF NOT EXISTS `visitors` (
  ...
  `visitor_phone` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `visitor_password` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `visitor_address` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
